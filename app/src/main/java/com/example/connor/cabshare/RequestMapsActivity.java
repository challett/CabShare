...
public class RequestMapsActivity extends FragmentActivity {
    ...
    private String getDirectionsUrl(LatLng origin, LatLng dest) {
        ...
        // Sensor enabled is always false
        String sensor = "sensor=false";
        // Build the parameters to the web service
        String parameters = str_origin + "&" + str_dest + "&" + sensor;
        // Output format
        String output = "json";
        // Build the url to the website; this can also be plugged into browser
